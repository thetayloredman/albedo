...
### Power Levels
The key roles in the Albedo protocol are associated with power levels:  | Role | Power Level | |---|---|
| CS | 80 |
| PN | 20 |
...
The PN should provide a list of its additional protocol "capabilities," which will be used in
...
```json
{
    "ping_server": "ping-server.com",     "pong_server": "pong-server.com",
    "ms": 400,
    "id": "<string>"
}
```
